const content = {
  ...
  explanation: `
We use the Past Continuous to describe actions that were in progress
at a specific time in the past.

It is also used when one past action was happening
and another action interrupted it.
  ...
  rules: [
    ...
    "Often used with time expressions like 'when' and 'while'"
  ],
  examples: [
